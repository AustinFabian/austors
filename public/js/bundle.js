...
exports.updateTour = exports.updateSettings = exports.newTour = exports.deleteEvent = exports.deleteClient = exports.deactivateSelf = void 0;
...
if (deleteTour) {
  ...
  for (var x in deleteButton) {
    deleteButton[x].addEventListener('click', function (e) {
      e.preventDefault();
