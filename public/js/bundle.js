...
exports.updateTour = exports.updateSettings = exports.newTour = exports.dropAReview = exports.deleteUserReview = exports.deleteEvent = exports.deleteClient = exports.deactivateSelf = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', "".concat(type, " changed succesfully"));
              location.reload(true);
            }
...
var updateTour = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(data, tourId) {
    var url, res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            console.log('error', _context3.t0.response.data.message);
  ...
  return function updateTour(_x4, _x5) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 8:
            ...
            console.log('error', _context4.t0.response.data.message);
...
var deleteClient = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            ...
            console.log('error', _context5.t0.response.data.message);
  ...
  return function deleteClient(_x7) {
...
var deactivateSelf = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 8:
            ...
            console.log('error', _context6.t0.response.data.message);
  ...
  return function deactivateSelf() {
    return _ref6.apply(this, arguments);
  };
}(); // TOUR REVIEW ENGINE


exports.deactivateSelf = deactivateSelf;

var dropAReview = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(review, tour) {
    var url, res;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            url = "/api/v1/reviews/".concat(tour);
            _context7.prev = 1;
            _context7.next = 4;
            return (0, _axios.default)({
              method: 'POST',
  ...
  return function dropAReview(_x8, _x9) {
    return _ref7.apply(this, arguments);
  };
}(); // DELETE USER REVIEW ENGINE


exports.dropAReview = dropAReview;

var deleteUserReview = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(reviewId) {
    var url, res;
  ...
  return function deleteUserReview(_x10) {
...
var stripe = Stripe('pk_test_51LKd9wGdzBwLXLVlm5pX2X5nGw4d6QUqsbax5ILvnOMOPCqLEUPInPTCSHpdyOU1r3i4UkPhfToeVjJ89t2tJuR600uZrUDXzL');
...
},{"axios":"../../node_modules/axios/index.js","/alert":"alert.js"}],"newjs.js":[function(require,module,exports) {
"use strict";
...
var logOutBtn2 = document.querySelector('.nav__el--logout1');
var userDataForm = document.querySelector('.form-user-data');
var tourUpdateForm = document.querySelector('.form-tour-update');
var createTourForm = document.querySelector('.form-create-tour');
var deleteTour = document.getElementById('deleteTour');
var deleteUser = document.querySelectorAll('.usersb');
var deleteReview = document.querySelectorAll('.reviewsb');
var deleteSelf = document.querySelectorAll('.removeAccount');
var userPasswordForm = document.querySelector('.form-user-password');
var reviewForm = document.getElementById('formReview');
var bookBtn = document.getElementById('book-tour');
var carousel = document.querySelector('.carousel'); // DELEGATION
...
if (logOutBtn2) logOutBtn2.addEventListener('click', _login.logOut); // FOR UPDATING A USER
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  ...
  var tour = document.getElementById('getTourId').getAttribute('title');
  (0, _updateSettings.dropAReview)(review, tour);
...
if (createTourForm) createTourForm.addEventListener('submit', function (e) {
  ...
  (0, _updateSettings.newTour)(form);
}); // FOR UPDATING TOUR
...
if (tourUpdateForm) tourUpdateForm.addEventListener('submit', function (e) {
  ...
  form.append('description', document.getElementById('description').value);
  form.append('summary', document.getElementById('summary').value);
  var Id = document.getElementById('id').getAttribute('title');
  (0, _updateSettings.updateTour)(form, Id);
}); // FOR UPDATE PASSWORD
...
var show = document.getElementsByClassName("hidden")[0];
var review = document.getElementById("tourReview");
var formReview = document.getElementById("formReview");
var contain = document.getElementsByClassName("containment")[0];
  ...
  deleteUser.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if (quest === 'yes') {
        ...
        (0, _updateSettings.deleteClient)(userId);
      } else {
        alert('wrong input');
      }
    });
...
if (deleteSelf) {
  deleteSelf.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      ...
      if (quest === 'yes') {
        (0, _updateSettings.deactivateSelf)();
      } else {
        alert('wrong input');
      }
    });
  ...
  deleteButton.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if (quest === 'yes') {
        ...
        (0, _updateSettings.deleteEvent)(tourId);
      } else {
        alert('Wrong input');
      }
    });
...
if (deleteReview) {
  deleteReview.forEach(function (item) {
    item.addEventListener('click', function (e) {
      e.preventDefault();
      ...
      if (quest === 'yes') {
        ...
        (0, _updateSettings.deleteUserReview)(reviewId);
      } else {
        alert('wrong input');
      }
    });
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","newjs.js"], null)
